...
**plase use the individual modules**: https://github.com/funcool/buddy-core[buddy-core], https://github.com/funcool/buddy-auth[buddy-auth], https://github.com/funcool/buddy-sign[buddy-sign]
and https://github.com/funcool/buddy-hashers[buddy-hashers].

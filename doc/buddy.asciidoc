...
_buddy_ is an authentication, authorization and cryptography/signing library for Clojure.
...
Behind the scenes, _buddy_ uses an low-level library exposed in the
`buddy.core` namespace, that contains implementations for:

- hash functions
- crypt functions
- mac functions
- digital signature functions
- encoding functions (base64, hex, ...)

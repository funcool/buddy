...
[NOTE] 
`make-password` accept distinct parameters depending on hashers. As example
bcrypt does not allow set own salt.
...
NOTE: in near future scrypt should to be implemented.
